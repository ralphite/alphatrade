...
def main():
    ...
    if not is_trading_day(now):
        ...
        for name, script in [("TOM", "tom_sleeve.py"), ("IEF", "ief_sleeve.py"), ("SVXY", "svxy_sleeve.py"), ("H6", "h6_sleeve.py"), ("H14-S", "vixy_shadow.py"), ("POSITIONS", "manage_positions.py"), ("REPORT", "report.py")]:
            try:
