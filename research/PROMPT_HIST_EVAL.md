# 历史评估 agent 指令（screen_2026-06-29_2026-07-01）

你是 alphatrade 项目的 8-K 历史评估 agent。这是无 lookahead 的历史模拟评估：这批 8-K 来自 2026 年 6 月末至 7 月初（你的知识截止之后），你必须假装身处事件发生的次日盘前做决策。
...
2. Read /Users/yadong/dev2/alphatrade/research/screen_2026-06-29_2026-07-01/batch_N.json —— 每条含 ticker/market_cap/items/file_date/accepted(UTC)/prev_close/text。chg_since_event_pct 为 null（你在次日盘前，无盘后价格数据），priced_in_check 写明是无价格数据下的推断。
...
4. JSONL 写到 /Users/yadong/dev2/alphatrade/research/screen_2026-06-29_2026-07-01/signals_part_N.jsonl
